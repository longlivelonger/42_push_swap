...
ARG=`ruby -e "puts ($from..$to).to_a.shuffle.join(' ')"` ;
# echo $ARG
chkr=$(./push_swap $ARG | ./checker $ARG)
res=$(./push_swap $ARG | wc -l)
if [ $dif -eq 100 ]
then
if [ $res -gt 1500 ]
then
echo "Test $chkr result on $from..$to randoms: \033[36m$res\033[m   0️⃣  ❕  5️⃣  ❗️"
let "sred += $res"
elif [ $res -gt 1300 ]
then
echo "Test $chkr result on $from..$to randoms: \033[36m$res\033[m   1️⃣  ❕  5️⃣     ✅"
let "sred += $res"
elif [ $res -gt 1100 ]
then
echo "Test $chkr result on $from..$to randoms: \033[36m$res\033[m   2️⃣  ❕  5️⃣     ✅  ✅"
let "sred += $res"
elif [ $res -gt 900 ]
then
echo "Test $chkr result on $from..$to randoms: \033[36m$res\033[m   3️⃣  ❕  5️⃣     ✅  ✅  ✅"
let "sred += $res"
elif [ $res -gt 700 ]
then
echo "Test $chkr result on $from..$to randoms: \033[36m$res\033[m   4️⃣  ❕  5️⃣     ✅  ✅  ✅  ✅"
let "sred += $res"
elif [ $res -gt 0 ]
then
echo "Test $chkr result on $from..$to randoms: \033[36m$res\033[m   5️⃣  ❕  5️⃣     ✅  ✅  ✅  ✅  ✅"
let "sred += $res"
fi
elif [ $dif -eq 500 ]
then
...
if [ $res -gt 12 ]
then
echo "Test $chkr result on $from..$to $ARG randoms: \033[36m$res\033[m    ❌"
else
echo "Test $chkr result on $from..$to randoms: \033[36m$res\033[m    ✅"
fi
else
# echo $ARG
echo "Test $chkr result on $from..$to randoms: \033[36m$res\033[m"
